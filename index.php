                    ...
                    <div class="owl-theme owl-carousel" id="testimonialCarousel">
                        <div class="item">
                            <div class="testimonial-card">
                                <div class="img">
                                    <img src="img/clients/clients-img-1.jpg" alt="Testimonial image" class="img-fluid" />
                                </div>
                                <div class="body">
                                    <h6>Allef Vinicius</h6>
                        ...
                        <div class="item">
                            <div class="testimonial-card">
                                <div class="img">
                                    <img src="img/clients/clients-img-2.jpg" alt="Testimonial image" class="img-fluid" />
                                </div>
                                <div class="body">
                                    <h6>Max Ilienerwise</h6>
                                    <span>Envato Customer</span>
                                    <div class="rating">
                                        <i class="far fa-star"></i>
                                        <i class="far fa-star"></i>
                        ...
                        <div class="item">
                            <div class="testimonial-card">
                                <div class="img">
                                    <img src="img/clients/clients-img-3.jpg" alt="Testimonial image" class="img-fluid" />
                                </div>
                                <div class="body">
                                    <h6>Zheka Boychenko</h6>
                                    <span>Envato Customer</span>
                                    <div class="rating">
                                        <i class="far fa-star"></i>
                                        <i class="far fa-star"></i>
                        ...
                        <div class="item">
                            <div class="testimonial-card">
                                <div class="img">
                                    <img src="img/clients/clients-img-4.jpg" alt="Testimonial image" class="img-fluid" />
                                </div>
                                <div class="body">
                                    <h6>Jonathan Borba</h6>
                                    <span>Envato Customer</span>
                                    <div class="rating">
                                        <i class="far fa-star"></i>
                                        <i class="far fa-star"></i>
                        ...
                        <div class="row">
                                ...
                                <div class="footer-widget">
                                    ...
                                    <ul class="footer-contact-info">
                                        <li>
                                            ...
                                            <a href="https://aipthemes.com/cdn-cgi/l/email-protection#c2a3aca3b7aea3ada4a4aba1a782a5afa3abaeeca1adaf">
                                                <span><span class="__cf_email__" data-cfemail="fc9d929d89909d939a9a959f99bc9b919d9590d29f9391">[email&#160;protected]</span></span>
                                            </a>
                                        </li>
                                        <li>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="footer-widget">
                                    ...
                                    <ul class="footer-links">
                                        <li>
                                            <a href="index-particles.html#">Home</a>
                                        </li>
                                        <li>
                                            <a href="index-particles.html#">About</a>
                                        </li>
                                        <li>
                                            <a href="index-particles.html#">Services</a>
                                        </li>
                                        <li>
                                            <a href="index-particles.html#">Blog</a>
                                        </li>
                                        <li>
                                            <a href="index-particles.html#">Gallery</a>
                                        </li>
                                        <li>
                                            <a href="index-particles.html#">Contact</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-3">
                                <div class="footer-widget">
                                    ...
                                    <ul class="footer-links">
                                        <li>
                                            <a href="index-particles.html#">Services Details</a>
                                        </li>
                                        <li>
                                            <a href="index-particles.html#">Privacy Policy</a>
                                        </li>
                                        <li>
                                            <a href="index-particles.html#">Cookies Policy</a>
                                        </li>
                                        <li>
                                            <a href="index-particles.html#">Supports Center</a>
                                        </li>
                                        <li>
                                            <a href="index-particles.html#">Terms & Conditions</a>
                                        </li>
                                        <li>
                                            <a href="index-particles.html#">Affiliate Programs</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-3">
                                <div class="footer-widget">
                                    <div class="newsletter-form-wrap">
                                        ...
                                        <form action="https://aipthemes.com/anaula/index-1.html">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <p class="copyright-text">
                                    &copy; 2020. Aip Themes. All Right Reserved
                                </p>
                            </div>
                            <div class="col-md-6">
